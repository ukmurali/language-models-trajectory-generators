...
class Environment:
    ...
    def load(self):
        ...
        object_model = p.loadURDF("ycb_assets/002_master_chef_can.urdf", object_start_position,
        ...
        if env_connection.poll():
            ...
            if env_connection_received[0] == CAPTURE_IMAGES:
                ...
                for point in trajectory:
                    robot.move(env, point[:3], np.array(robot.ee_start_orientation_e) + np.array([0, 0, point[3]]),
                               gripper_open=robot.gripper_open, is_trajectory=True)
